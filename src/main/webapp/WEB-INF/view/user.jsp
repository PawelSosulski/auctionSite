        ...
        <div class="columns is-centered">
            <div class="column is-two-thirds">
                <div class="field is-grouped has-addons has-addons-centered">
                    <div class="control is-vertical-center"><h3 class="title is-3">${user.login}</h3></div>
                    <div class="control">
                ...
                <div style="margin-top: 60px" class="field">
                    <article class="panel is-success">
                        ...
                        <c:choose>
                            <c:when test="${userAuctions.size() > 0}">
                            ...
                            <c:otherwise>
                                <div class="field has-addons has-addons-centered">
                                    <p class="subtitle is-5" style="margin-top: 20px; margin-bottom: 20px;">This user
                                        does not currently have an auctions.</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </article>
                ...
                <div style="margin-top: 60px" class="field">
                    <article class="panel is-success">
                        ...
                        <c:choose>
                            <c:when test="${purchases.size() > 0 || sales.size() > 0}">
                                <table class="table is-hoverable is-fullwidth">
                                    <tr>
                                        <th>Auction</th>
                                        <th>Role</th>
                            ...
                            <c:otherwise>
                                <div class="field has-addons has-addons-centered">
                                    <p class="subtitle is-5" style="margin-top: 20px; margin-bottom: 20px;">This user
                                        has no opinion on this moment.</p>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </article>
