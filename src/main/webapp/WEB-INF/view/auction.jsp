        ...
        <div class="columns">
            <div class="column">
                <div class="field is-grouped">
                    ...
                    <c:if test="${auction.status == 'PENDING' && !isUserAuction}">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <div><a href="/user/${seller.login}">${seller.login}</a></div>
                    </div>
                </div>
                <div class="field">
                                                    ...
                                                    <article class="message is-success">
                                                        ...
                                                        <div class="message-body">
                                                            <form:input cssClass="input" path="value" type="number"
                                                                        ...
                                                                        style="width: auto;"/>
                                                            <button type="submit" class="button is-link is-success">MAKE
                                                                BID
                                                            </button>
                                                        </div>
                                                    </article>
                                            ...
                                            <c:otherwise>
                                                <div class="control">
                                                    <article class="message is-danger">
                                                        <div class="message-header"><p>YOU CAN'T MAKE BID YOUR
                                                            AUCTION</p></div>
                                                        <div class="message-body">
                                                            <form:input cssClass="input" path="value" type="number"
                                                                        value="${auction.actualPrice}"
                                                            ...
                                                            <button type="submit" class="button is-link is-danger"
                                                                    disabled>MAKE
                                                                BID
                                                            </button>
                                                        </div>
                                ...
                                <c:choose>
                                    <c:when test="${!isUserAuction}">
                                        <form:form method="POST" action="/buyAuction" modelAttribute="auction">
                                            ...
                                            <div class="control">
                                                <article class="message is-success">
                                                    <div class="message-header"><p>BUY NOW
                                                        PRICE: ${auction.buyNowPrice}</p>
                                                    </div>
                                                    <div class="message-body">
                                    ...
                                    <c:otherwise>
                                        <article class="message is-danger">
                                            <div class="message-header"><p>YOU CAN'T BUY YOUR AUCTION</p></div>
